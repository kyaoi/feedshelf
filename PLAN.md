...
- [ ] `FS-DX-01` Biome を baseline formatter / linter として導入する
- [ ] `FS-DX-02` quality gate の単一入口と hook 役割を整合させる
- [ ] `FS-DX-03` 通常 CI workflow を追加する
...
- `FS-DX-01` で Biome baseline と対象範囲を最小差分で導入する
