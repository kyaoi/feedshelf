...
- [ ] `FS-TS-00` TypeScript 移行方針を docs に固定する
- [ ] `FS-TS-01` TypeScript 実行基盤と型検査を導入する
- [ ] `FS-TS-02` pipeline のデータ契約と主要処理を TS 化する
- [ ] `FS-TS-03` public web UI ロジックを TS 化する
- [ ] `FS-TS-04` tests / lint / verify フローを TS 前提に更新する
- [ ] `FS-TS-05` strictness を段階的に引き上げる
...
1. `FS-TS-00`: TypeScript 移行方針を docs に固定する
