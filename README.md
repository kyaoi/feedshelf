...
- community source でも source 自身または first-party help / docs で feed path が確認できる topic feed は `enabled=true` にしてよく、broad feed や evidence の薄い topic feed は `enabled=false` のまま保持してよい
